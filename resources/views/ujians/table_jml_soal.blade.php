...
@endphp
Pilihan Ganda : <b>{{ $totalPG != null ? count($totalPG) : '0' }}</b> @role('Admin|Dosen') dari <b>{{ $jml_pg }}@endrole</b><br>
Essay : <b>{{ $totalEssay != null ? count($totalEssay) : '0' }}</b> @role('Admin|Dosen') dari <b>{{ $jml_essay }}@endrole</b><br><br>
@role('Admin|Dosen')
