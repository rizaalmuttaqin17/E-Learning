<div class="card">
    ...
    <div class="card-body">
        ...
        @if ($question['id_tipe_soal'] == 2)
            ...
            <input id="answer{{ $question['id'] }}" name="answer{{ $question['id'] }}" class="form-control jawaban" wire:change="answer({{ $question['id'] }}, $tes)" value="{{ $tes }}" style="height: 250px"/>
            ...
            {{-- @if(COUNT($jawabanTerpilih)>0) --}}
                <script>
                    ...
                    document.addEventListener('trix-blur', function(e){
                        ...
                        element.editor.insertHTML(document.querySelector("trix-editor").value);
                    });
                </script>
