...
class KategoriController extends AppBaseController
{
    ...
    public function store(CreateKategoriRequest $request)
    {
        ...
        Flash::success(__('messages.saved', ['model' => __('models/kategoris.singular')]));
    ...
    public function show($id)
    {
        ...
        if (empty($kategori)) {
            Flash::error(__('messages.not_found', ['model' => __('models/kategoris.singular')]));
    ...
    public function update($id, UpdateKategoriRequest $request)
    {
        ...
        Flash::success(__('messages.updated', ['model' => __('models/kategoris.singular')]));
    ...
    public function destroy($id)
    {
        ...
        Flash::success(__('messages.deleted', ['model' => __('models/kategoris.singular')]));
